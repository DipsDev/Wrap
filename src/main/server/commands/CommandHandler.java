...
public class CommandHandler {
    ...
    private static final String COMMANDS_LOCATION_PACKAGE = "main.server.commands.registers";
    private static final String COMMANDS_LOCATION_URL = "main/server/commands/registers";
